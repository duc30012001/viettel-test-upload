...
const App = () => {
  ...
  const handleUpload = async () => {
    ...
    if (distributor === "AZURE") {
      ...
      await uploadToViettel(file, handleChangeProgress);
    } else {
      await uploadToLongVan(file, handleChangeProgress);
    }
    const endTime = new Date();
    alert(`Hoàn thành trong ${convertTime}`);
  };
